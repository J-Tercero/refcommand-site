...
The public 2026-season foundation is live as a static site. An active read-only Weekly Pregame briefing and a preserved full-featured sample template are available alongside the homepage, meeting briefings, and destination-page prototypes. RefCommand does not invent live or editorial content, and rules explanations remain original summaries with references rather than reproduced rulebook text.
...
pregame/      Shareable weekly pregame routes
